...
part 'package:libinterval/iterator.dart';
...
class IntervalSet<T extends Comparable<T>> extends IterableMixin<Interval<T>> {
  ...
  IntervalSet.copy(IntervalSet<T> other) {
  ...
  @override
  Iterator<Interval<T>> get iterator => _intervals.iterator;

  @override
  int get length => _intervals.length;

  @override
  Interval<T> get first => _intervals.first;
  @override
  Interval<T> get last => _intervals.last;

  @override
  bool get isEmpty => _intervals.isEmpty;
  @override
  bool get isNotEmpty => _intervals.isNotEmpty;
